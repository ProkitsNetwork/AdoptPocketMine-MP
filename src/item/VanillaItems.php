...
final class VanillaItems{
	...
	protected static function setup() : void{
		...
		self::register("egg", static fn(int $id) => new Egg($id, "Egg"));
		self::register("emerald", static fn(int $id) => new Item($id, "Emerald"));
		self::register("enchanted_book", static fn(int $id) => new EnchantedBook($id, "Enchanted Book", [EnchantmentTags::ALL]));
		self::register("enchanted_golden_apple", static fn(int $id) => new GoldenAppleEnchanted($id, "Enchanted Golden Apple"));
		self::register("end_crystal", static fn(int $id) => new EndCrystal($id, "End Crystal"));
		self::register("ender_pearl", static fn(int $id) => new EnderPearl($id, "Ender Pearl"));
		self::register("experience_bottle", static fn(int $id) => new ExperienceBottle($id, "Bottle o' Enchanting"));
		self::register("feather", static fn(int $id) => new Item($id, "Feather"));
		self::register("fermented_spider_eye", static fn(int $id) => new Item($id, "Fermented Spider Eye"));
		self::register("firework_rocket", static fn(int $id) => new FireworkRocket($id, "Firework Rocket"));
		self::register("firework_star", static fn(int $id) => new FireworkStar($id, "Firework Star"));
		self::register("fire_charge", static fn(int $id) => new FireCharge($id, "Fire Charge"));
		self::register("fishing_rod", static fn(int $id) => new FishingRod($id, "Fishing Rod", [EnchantmentTags::FISHING_ROD]));
		self::register("flint", static fn(int $id) => new Item($id, "Flint"));
		self::register("flint_and_steel", static fn(int $id) => new FlintSteel($id, "Flint and Steel", [EnchantmentTags::FLINT_AND_STEEL]));
		self::register("ghast_tear", static fn(int $id) => new Item($id, "Ghast Tear"));
		self::register("glass_bottle", static fn(int $id) => new GlassBottle($id, "Glass Bottle"));
		self::register("glistering_melon", static fn(int $id) => new Item($id, "Glistering Melon"));
		self::register("glow_berries", static fn(int $id) => new GlowBerries($id, "Glow Berries"));
		self::register("glow_ink_sac", static fn(int $id) => new Item($id, "Glow Ink Sac"));
		self::register("glowstone_dust", static fn(int $id) => new Item($id, "Glowstone Dust"));
		self::register("goat_horn", static fn(int $id) => new GoatHorn($id, "Goat Horn"));
		self::register("gold_ingot", static fn(int $id) => new Item($id, "Gold Ingot"));
		self::register("gold_nugget", static fn(int $id) => new Item($id, "Gold Nugget"));
		self::register("golden_apple", static fn(int $id) => new GoldenApple($id, "Golden Apple"));
		self::register("golden_carrot", static fn(int $id) => new GoldenCarrot($id, "Golden Carrot"));
		self::register("gunpowder", static fn(int $id) => new Item($id, "Gunpowder"));
		self::register("heart_of_the_sea", static fn(int $id) => new Item($id, "Heart of the Sea"));
		self::register("honey_bottle", static fn(int $id) => new HoneyBottle($id, "Honey Bottle"));
		self::register("honeycomb", static fn(int $id) => new Item($id, "Honeycomb"));
		self::register("ice_bomb", static fn(int $id) => new IceBomb($id, "Ice Bomb"));
		self::register("ink_sac", static fn(int $id) => new Item($id, "Ink Sac"));
		self::register("iron_ingot", static fn(int $id) => new Item($id, "Iron Ingot"));
		self::register("iron_nugget", static fn(int $id) => new Item($id, "Iron Nugget"));
		self::register("jungle_sign", static fn(int $id) => new ItemBlockWallOrFloor($id, Blocks::JUNGLE_SIGN(), Blocks::JUNGLE_WALL_SIGN()));
		self::register("jungle_hanging_sign", static fn(int $id) => new HangingSign($id, "Jungle Hanging Sign", Blocks::JUNGLE_CEILING_CENTER_HANGING_SIGN(), Blocks::JUNGLE_CEILING_EDGES_HANGING_SIGN(), Blocks::JUNGLE_WALL_HANGING_SIGN()));
		...
		self::register("medicine", static fn(int $id) => new Medicine($id, "Medicine"));
		self::register("melon", static fn(int $id) => new Melon($id, "Melon"));
		self::register("melon_seeds", static fn(int $id) => new MelonSeeds($id, "Melon Seeds"));
		self::register("milk_bucket", static fn(int $id) => new MilkBucket($id, "Milk Bucket"));
		self::register("minecart", static fn(int $id) => new Minecart($id, "Minecart"));
		self::register("mushroom_stew", static fn(int $id) => new MushroomStew($id, "Mushroom Stew"));
		self::register("name_tag", static fn(int $id) => new NameTag($id, "Name Tag"));
		self::register("nautilus_shell", static fn(int $id) => new Item($id, "Nautilus Shell"));
		self::register("nether_brick", static fn(int $id) => new Item($id, "Nether Brick"));
		...
		self::register("oak_sign", static fn(int $id) => new ItemBlockWallOrFloor($id, Blocks::OAK_SIGN(), Blocks::OAK_WALL_SIGN()));
		self::register("oak_hanging_sign", static fn(int $id) => new HangingSign($id, "Oak Hanging Sign", Blocks::OAK_CEILING_CENTER_HANGING_SIGN(), Blocks::OAK_CEILING_EDGES_HANGING_SIGN(), Blocks::OAK_WALL_HANGING_SIGN()));
		self::register("ominous_banner", static fn(int $id) => new ItemBlockWallOrFloor($id, Blocks::OMINOUS_BANNER(), Blocks::OMINOUS_WALL_BANNER()));
		self::register("painting", static fn(int $id) => new PaintingItem($id, "Painting"));
		self::register("pale_oak_sign", static fn(int $id) => new ItemBlockWallOrFloor($id, Blocks::PALE_OAK_SIGN(), Blocks::PALE_OAK_WALL_SIGN()));
		self::register("pale_oak_hanging_sign", static fn(int $id) => new HangingSign($id, "Pale Oak Hanging Sign", Blocks::PALE_OAK_CEILING_CENTER_HANGING_SIGN(), Blocks::PALE_OAK_CEILING_EDGES_HANGING_SIGN(), Blocks::PALE_OAK_WALL_HANGING_SIGN()));
		self::register("paper", static fn(int $id) => new Item($id, "Paper"));
		self::register("phantom_membrane", static fn(int $id) => new Item($id, "Phantom Membrane"));
		self::register("pitcher_pod", static fn(int $id) => new PitcherPod($id, "Pitcher Pod"));
		self::register("poisonous_potato", static fn(int $id) => new PoisonousPotato($id, "Poisonous Potato"));
		self::register("popped_chorus_fruit", static fn(int $id) => new Item($id, "Popped Chorus Fruit"));
		self::register("potato", static fn(int $id) => new Potato($id, "Potato"));
		self::register("potion", static fn(int $id) => new Potion($id, "Potion"));
		self::register("prismarine_crystals", static fn(int $id) => new Item($id, "Prismarine Crystals"));
		self::register("prismarine_shard", static fn(int $id) => new Item($id, "Prismarine Shard"));
		self::register("pufferfish", static fn(int $id) => new Pufferfish($id, "Pufferfish"));
		self::register("pumpkin_pie", static fn(int $id) => new PumpkinPie($id, "Pumpkin Pie"));
		self::register("pumpkin_seeds", static fn(int $id) => new PumpkinSeeds($id, "Pumpkin Seeds"));
		self::register("rabbit_foot", static fn(int $id) => new Item($id, "Rabbit's Foot"));
		self::register("rabbit_hide", static fn(int $id) => new Item($id, "Rabbit Hide"));
		self::register("rabbit_stew", static fn(int $id) => new RabbitStew($id, "Rabbit Stew"));
		self::register("raw_beef", static fn(int $id) => new RawBeef($id, "Raw Beef"));
		self::register("raw_chicken", static fn(int $id) => new RawChicken($id, "Raw Chicken"));
		self::register("raw_copper", static fn(int $id) => new Item($id, "Raw Copper"));
		self::register("raw_fish", static fn(int $id) => new RawFish($id, "Raw Fish"));
		self::register("raw_gold", static fn(int $id) => new Item($id, "Raw Gold"));
		self::register("raw_iron", static fn(int $id) => new Item($id, "Raw Iron"));
		self::register("raw_mutton", static fn(int $id) => new RawMutton($id, "Raw Mutton"));
		self::register("raw_porkchop", static fn(int $id) => new RawPorkchop($id, "Raw Porkchop"));
		self::register("raw_rabbit", static fn(int $id) => new RawRabbit($id, "Raw Rabbit"));
		self::register("raw_salmon", static fn(int $id) => new RawSalmon($id, "Raw Salmon"));
		self::register("record_11", static fn(int $id) => new Record($id, RecordType::DISK_11, "Record 11"));
		self::register("record_13", static fn(int $id) => new Record($id, RecordType::DISK_13, "Record 13"));
		self::register("record_5", static fn(int $id) => new Record($id, RecordType::DISK_5, "Record 5"));
		self::register("record_blocks", static fn(int $id) => new Record($id, RecordType::DISK_BLOCKS, "Record Blocks"));
		self::register("record_cat", static fn(int $id) => new Record($id, RecordType::DISK_CAT, "Record Cat"));
		self::register("record_chirp", static fn(int $id) => new Record($id, RecordType::DISK_CHIRP, "Record Chirp"));
		self::register("record_creator", static fn(int $id) => new Record($id, RecordType::DISK_CREATOR, "Record Creator"));
		self::register("record_creator_music_box", static fn(int $id) => new Record($id, RecordType::DISK_CREATOR_MUSIC_BOX, "Record Creator (Music Box)"));
		self::register("record_far", static fn(int $id) => new Record($id, RecordType::DISK_FAR, "Record Far"));
		self::register("record_mall", static fn(int $id) => new Record($id, RecordType::DISK_MALL, "Record Mall"));
		self::register("record_mellohi", static fn(int $id) => new Record($id, RecordType::DISK_MELLOHI, "Record Mellohi"));
		self::register("record_otherside", static fn(int $id) => new Record($id, RecordType::DISK_OTHERSIDE, "Record Otherside"));
		self::register("record_pigstep", static fn(int $id) => new Record($id, RecordType::DISK_PIGSTEP, "Record Pigstep"));
		self::register("record_precipice", static fn(int $id) => new Record($id, RecordType::DISK_PRECIPICE, "Record Precipice"));
		self::register("record_relic", static fn(int $id) => new Record($id, RecordType::DISK_RELIC, "Record Relic"));
		self::register("record_stal", static fn(int $id) => new Record($id, RecordType::DISK_STAL, "Record Stal"));
		self::register("record_strad", static fn(int $id) => new Record($id, RecordType::DISK_STRAD, "Record Strad"));
		self::register("record_wait", static fn(int $id) => new Record($id, RecordType::DISK_WAIT, "Record Wait"));
		self::register("record_ward", static fn(int $id) => new Record($id, RecordType::DISK_WARD, "Record Ward"));
		self::register("recovery_compass", static fn(int $id) => new Item($id, "Recovery Compass"));
		self::register("redstone_dust", static fn(int $id) => new Redstone($id, "Redstone"));
		self::register("resin_brick", static fn(int $id) => new Item($id, "Resin Brick"));
		self::register("rotten_flesh", static fn(int $id) => new RottenFlesh($id, "Rotten Flesh"));
		self::register("scute", static fn(int $id) => new Item($id, "Scute"));
		self::register("shears", static fn(int $id) => new Shears($id, "Shears", [EnchantmentTags::SHEARS]));
		self::register("shulker_shell", static fn(int $id) => new Item($id, "Shulker Shell"));
		self::register("slimeball", static fn(int $id) => new Item($id, "Slimeball"));
		self::register("snowball", static fn(int $id) => new Snowball($id, "Snowball"));
		self::register("spider_eye", static fn(int $id) => new SpiderEye($id, "Spider Eye"));
		self::register("splash_potion", static fn(int $id) => new SplashPotion($id, "Splash Potion"));
		self::register("spruce_sign", static fn(int $id) => new ItemBlockWallOrFloor($id, Blocks::SPRUCE_SIGN(), Blocks::SPRUCE_WALL_SIGN()));
		self::register("spruce_hanging_sign", static fn(int $id) => new HangingSign($id, "Spruce Hanging Sign", Blocks::SPRUCE_CEILING_CENTER_HANGING_SIGN(), Blocks::SPRUCE_CEILING_EDGES_HANGING_SIGN(), Blocks::SPRUCE_WALL_HANGING_SIGN()));
		self::register("spyglass", static fn(int $id) => new Spyglass($id, "Spyglass"));
		self::register("steak", static fn(int $id) => new Steak($id, "Steak"));
		self::register("stick", static fn(int $id) => new Stick($id, "Stick"));
		self::register("string", static fn(int $id) => new StringItem($id, "String"));
		self::register("sugar", static fn(int $id) => new Item($id, "Sugar"));
		self::register("suspicious_stew", static fn(int $id) => new SuspiciousStew($id, "Suspicious Stew"));
		self::register("sweet_berries", static fn(int $id) => new SweetBerries($id, "Sweet Berries"));
		self::register("torchflower_seeds", static fn(int $id) => new TorchflowerSeeds($id, "Torchflower Seeds"));
		self::register("totem", static fn(int $id) => new Totem($id, "Totem of Undying"));
		self::register("trident", static fn(int $id) => new Trident($id, "Trident"));
		self::register("warped_sign", static fn(int $id) => new ItemBlockWallOrFloor($id, Blocks::WARPED_SIGN(), Blocks::WARPED_WALL_SIGN()));
		self::register("warped_hanging_sign", static fn(int $id) => new HangingSign($id, "Warped Hanging Sign", Blocks::WARPED_CEILING_CENTER_HANGING_SIGN(), Blocks::WARPED_CEILING_EDGES_HANGING_SIGN(), Blocks::WARPED_WALL_HANGING_SIGN()));
		self::register("water_bucket", static fn(int $id) => new LiquidBucket($id, "Water Bucket", Blocks::WATER()));
		self::register("wheat", static fn(int $id) => new Item($id, "Wheat"));
		self::register("wheat_seeds", static fn(int $id) => new WheatSeeds($id, "Wheat Seeds"));
		self::register("writable_book", static fn(int $id) => new WritableBook($id, "Book & Quill"));
		self::register("written_book", static fn(int $id) => new WrittenBook($id, "Written Book"));

		foreach(BoatType::cases() as $type){
			//boat type is static, because different types of wood may have different properties
			self::register(strtolower($type->name) . "_boat", static fn(int $id) => new Boat($id, $type->getDisplayName() . " Boat", $type));
		}
	}

	private static function registerSpawnEggs() : void{
		self::register("zombie_spawn_egg", static fn(int $id) => new class($id, "Zombie Spawn Egg") extends SpawnEgg{
			protected function createEntity(World $world, Vector3 $pos, float $yaw, float $pitch) : Entity{
				return new Zombie(Location::fromObject($pos, $world, $yaw, $pitch));
			}
		});
		self::register("squid_spawn_egg", static fn(int $id) => new class($id, "Squid Spawn Egg") extends SpawnEgg{
			protected function createEntity(World $world, Vector3 $pos, float $yaw, float $pitch) : Entity{
				return new Squid(Location::fromObject($pos, $world, $yaw, $pitch));
			}
		});
		self::register("villager_spawn_egg", static fn(int $id) => new class($id, "Villager Spawn Egg") extends SpawnEgg{
			protected function createEntity(World $world, Vector3 $pos, float $yaw, float $pitch) : Entity{
	...
	private static function registerSmithingTemplates() : void{
		self::register("netherite_upgrade_smithing_template", static fn(int $id) => new Item($id, "Netherite Upgrade Smithing Template"));
		self::register("coast_armor_trim_smithing_template", static fn(int $id) => new Item($id, "Coast Armor Trim Smithing Template"));
		self::register("dune_armor_trim_smithing_template", static fn(int $id) => new Item($id, "Dune Armor Trim Smithing Template"));
		self::register("eye_armor_trim_smithing_template", static fn(int $id) => new Item($id, "Eye Armor Trim Smithing Template"));
		self::register("host_armor_trim_smithing_template", static fn(int $id) => new Item($id, "Host Armor Trim Smithing Template"));
		self::register("raiser_armor_trim_smithing_template", static fn(int $id) => new Item($id, "Raiser Armor Trim Smithing Template"));
		self::register("rib_armor_trim_smithing_template", static fn(int $id) => new Item($id, "Rib Armor Trim Smithing Template"));
		self::register("sentry_armor_trim_smithing_template", static fn(int $id) => new Item($id, "Sentry Armor Trim Smithing Template"));
		self::register("shaper_armor_trim_smithing_template", static fn(int $id) => new Item($id, "Shaper Armor Trim Smithing Template"));
		self::register("silence_armor_trim_smithing_template", static fn(int $id) => new Item($id, "Silence Armor Trim Smithing Template"));
		self::register("snout_armor_trim_smithing_template", static fn(int $id) => new Item($id, "Snout Armor Trim Smithing Template"));
		self::register("spire_armor_trim_smithing_template", static fn(int $id) => new Item($id, "Spire Armor Trim Smithing Template"));
		self::register("tide_armor_trim_smithing_template", static fn(int $id) => new Item($id, "Tide Armor Trim Smithing Template"));
